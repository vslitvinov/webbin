...
function GetCartInfo() {
    ...
    let tempO = '<div class="pb-4"><a href="{Url}" class="d-flex align-items-center"><img src="{Icon}" class="shadow rounded" style="max-height: 64px;" alt=""><div class="flex-1 text-start ms-3"><h6 class="text-dark mb-0">{Name}</h6><p class="text-muted mb-0">$ {Price} X {Count}</p></div><h6 class="text-dark mb-0">$ {TotalPrice}</h6></a></div>'
